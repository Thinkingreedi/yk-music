...
export const fetchTopListDataAction = createAsyncThunk('toplist', async (arg, { dispatch }) => {
...
export const { changeTopListAction, changeCurrentIndexAction, changePlayListAction } = rankingSlice.actions
