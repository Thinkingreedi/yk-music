...
export const fetchDjradioDataAction = createAsyncThunk('djradio', async (arg, { dispatch }) => {
...
export const { changeCategoryAction, changeRecommendsAction, changeCurrentIdAction, changeRadiosAction } =
